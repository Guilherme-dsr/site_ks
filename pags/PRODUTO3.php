...
<main id="main">
        ...
        <div class="container">
          <div class="row align-items-stretch">
            <div class="col-md-8" data-aos="fade-up">
              <img src="../img/3.jpg" alt="Image" class="img-fluid" width="1000" height="1000">
            </div>
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h3 class="h2" style="color: #76ff03">Adidas Ulta Boost</h3>
  ...
  <div class="custom-control custom-radio custom-control-inline">
    ...
    <label class="custom-control-label" for="customRadio2" style="color: white">37</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio3" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio3" style="color: white">42</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio4" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio4" style="color: white">44</label>
  </div>
                ...
                <ul class="list-unstyled list-line mb-5">
                  ...
                  <li style="color: white">Molas confont 5cm/Preto</li>
                  <li style="color: white">R$ 170,00</li>
                </ul>
