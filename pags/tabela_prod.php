...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark info-color elegant-color-dark indigo fixed-top scrolling-navbar"  >
  ...
  <a class="navbar-brand" href="" style="color: #76ff03" >Tabela de Produtos</a>
...
<a href="cadastros/cadastro_prod.php" target="_blank"><button type="button" class="btn light-green accent-3">+</button></a>
</div>
...
<table class="table" style="color:white;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php  if($dado['data_atualizada'] != ""){ echo date("d/m/Y", strtotime($dado['data_atualizada'])); }   ?></td>
      <td><a href="cadastros/cadastro_prod_edit.php?id=<?php echo $dado["id"]; ?>"><font color="#76FF03">Editar</a></font></td>
      <td><a href="../php/delete.php?id=<?php echo $dado["id"]; ?>"><font color="red">Deletar</font></a></td>
      <td></td>
    </tr>
    <?php } ?>
  </tbody>
