...
<ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link waves-effect" style="color: #76ff03" href="./sPRODUTO2.php">Nike</a>
          </li>
        </ul>
        ...
        <div class="container">
          <div class="row align-items-stretch">
            <div class="col-md-8" data-aos="fade-up">
              <img src="../img/new.jpg" alt="Image" class="img-fluid" width="1000" height="1000">
            </div>
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h3 class="h2" style="color: #76ff03">Nike Run Joyride Flyknit</h3>

                <h4 class="h4 mb-3" style="color: #5c5952">Tamanho</h4>
                <ul class="list-unstyled list-line mb-5">
                  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio" style="color: white">38</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio2" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio2" style="color: white">40</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio3" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio3" style="color: white">41</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio4" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio4" style="color: white">42</label>
  </div>
                ...
                <div class="mb-5" style="color: white">
                  <p>Tênis Nike Joyride Run Masculino O máximo de conforto com uma pegada diferente. O Nike Joyride proporciona maior conforto e leveza aos corredores ocasionais e para o seu dia a dia.</p>
                ...
                <ul class="list-unstyled list-line mb-5">
                  <li style="color: white">Nike</li>
                  <li style="color: white">Tênis, Esportivos</li>
                  <li style="color: white">R$ 299,99</li>
                  <li style="color: #76ff03">Frete Gratis!</li>
                </ul>
        ...
        <div class="container">
          <div class="row justify-content-center text-center mb-4">
            <div class="col-5">
              ...
              <p style="color: white">Veja também os outros calçados Nike:</p>
            </div>
          </div>
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            <div class="item web col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="../pags/PRODUTO2.php" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>NIKE Air Force 1 Low Off-White Volt</h3>
                  <span>249,99</span>
                </div>
            ...
            <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="work-single.html" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>Nike Ultra boost 3</h3>
                  <h3 style="color: red">Esgotado</h3>
                  <span>289,99</span>
                </div>
                <img class="img-fluid" src="../img/55.jpg">
              </a>
            </div>
            <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="work-single.html" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>NIke Head Yeuzy</h3>
                  <h3 style="color: red">Esgotado</h3>
                  <span>259,99</span>
                </div>
                <img class="img-fluid" src="../img/indisponivel2.jpg">
              </a>
            </div>
