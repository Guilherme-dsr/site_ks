        ...
        <div class="container">
          <div class="row align-items-stretch">
            <div class="col-md-8" data-aos="fade-up">
              <img src="../img/4.jpg" alt="Image" class="img-fluid" width="1000" height="1000">
            </div>
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h3 class="h2" style="color: #76ff03">Sapatênis Ragran Casual Branco</h3>

                <h4 class="h4 mb-3" style="color: #5c5952">Tamanho</h4>
                <ul class="list-unstyled list-line mb-5">
                  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio" style="color: white">25</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio2" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio2" style="color: white">27</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio3" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio3" style="color: white">28</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio4" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio4" style="color: white">30</label>
  </div>
                ...
                <div class="mb-5" style="color: white">
                  <p>Esse sapato combina com seu filho. A parte superior da malha é acentuada com detalhes bordados e uma gaiola de salto translúcido. Os plugues EVA icônicos acentuam a entressola Boost, o amortecimento mais responsivo da Ragran.</p>
                ...
                <ul class="list-unstyled list-line mb-5">
                  <li style="color: white">Ragran</li>
                  <li style="color: white">Leve e macio</li>
                  <li style="color: white">R$ 49,99</li>
                </ul>
        ...
        <div class="container">
          <div class="row justify-content-center text-center mb-4">
            <div class="col-5">
              ...
              <p style="color: white">Veja também os outros calçados Ragran Infantil:</p>
            </div>
          </div>
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="work-single.html" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>Tenis Masculino Ragran Infantil Sapatênis Camuflado Criança</h3>
                  <h3 style="color: red">Esgotado</h3>
                  <span>59,99</span>
                </div>
                <img class="img-fluid" src="../img/infatil1.jpg">
              </a>
            </div>
            <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="work-single.html" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>Tenis Ragran Black kids</h3>
                  <h3 style="color: red">Esgotado</h3>
                  <span>59,99</span>
                </div>
                <img class="img-fluid" src="../img/infatil2.jpg">
              </a>
            </div>
            <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="work-single.html" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>Sapatenis Ragran Couro Feminino Kids</h3>
                  <h3 style="color: red">Esgotado</h3>
                  <span>36,89</span>
                </div>
                <img class="img-fluid" src="../img/infatil3.jpg">
              </a>
            </div>
