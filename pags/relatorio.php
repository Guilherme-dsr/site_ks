...
<div >
  <table border="2" align="center">
    ...
    <tr>
      <td><h5><font color="white">Data inicial</h5></td>
      <td><input type="date" name="data_inicial"></td>
    </tr>

    <tr>
      <td><h5><font color="white">Data final</h5></td>
...
<button type="submit" class="btn btn-rounded btn-blue-grey"><i class="far fa-save pr-2" aria-hidden="true"></i>Gerar Relatório</button>
</form>
</div>
