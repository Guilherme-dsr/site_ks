        ...
        <div class="container">
          <div class="row align-items-stretch">
            <div class="col-md-8" data-aos="fade-up">
              <img src="../img/2.jpg" alt="Image" class="img-fluid" width="1000" height="1000">
            </div>
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h3 class="h2" style="color: #76ff03">Nike Air Force 1</h3>

                <h4 class="h4 mb-3" style="color: #5c5952">Tamanho</h4>
                <ul class="list-unstyled list-line mb-5">
                  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio" style="color: white">36</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" class="custom-control-input" id="customRadio2" name="example" value="customEx">
    <label class="custom-control-label" for="customRadio2" style="color: white">38</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
  ...
  <div class="custom-control custom-radio custom-control-inline">
    ...
    <label class="custom-control-label" for="customRadio4" style="color: white">42</label>
                ...
                <div class="mb-5" style="color: white">
                  <p>Tênis Nike Air Force Run Masculino O máximo de conforto com uma pegada diferente. O Nike Air proporciona maior conforto e leveza aos corredores ocasionais e para o seu dia a dia.</p>
                ...
                <ul class="list-unstyled list-line mb-5">
                  ...
                  <li style="color: white">Tênis, Verde Limão</li>
                  <li style="color: white">R$ 249,99</li>
                </ul>
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            <div class="item web col-sm-6 col-md-4 col-lg-4 mb-4">
              <a href="../pags/PRODUTO5.php"" class="item-wrap fancybox">
                <div class="work-info">
                  <h3>Nike Run Joyride Flyknit</h3>
                  <span>299,99</span>
                </div>
