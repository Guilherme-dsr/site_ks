...
<div class="container">
  <p class="text-center"><a href="../home.php"><font size="6" color="#76ff03">CLIQUE AQUI PARA VOLTAR AS COMPRAS!</a></font></p>
<p class="text-center"><font size="5" color="red">ERRO AO COMPRAR! </font><br> <font size="5" color="white"><?php 
          if(isset($_SESSION['nome_comprador'])){
             echo $_SESSION['nome_comprador'];
           }
           ?> provavelmente não temos a quantidade selecionada em estoque. <br> Só temos 
           <?php 
          if(isset($_SESSION['quantidade'])){
             echo $_SESSION['quantidade'];
           }
           ?> unidades em estoque. <br>
            Tente novamente mais tarde!</p></font>
</div>
