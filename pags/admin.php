...
<body style="background-color: #212121">
  ...
  <a class="navbar-brand" href="" style="color: #76ff03" >Administrador</a>
...
<ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link waves-effect"  style="color: #76ff03" href="cadastros/cadastro_prog.php" target="_blank">Cadastrar Programador</a>
          </li>
          <li class="nav-item">
            <a class="nav-link waves-effect"  style="color: #76ff03" href="./tabela_programadores.php" target="_blank">Tabela de Programadores</a>
          </li>
          <li class="nav-item">
            <a class="nav-link waves-effect" style="color: #76ff03" href="cadastros/cadastro_prod.php" target="_blank">Cadastrar Produto</a>
          </li>
          <li class="nav-item">
...
<div class="card-deck mt-5 ml-3 mr-3">
  <a href="./cadastros/cadastro_prog.php" target="_blank">
  <div class="card">
    <img class="card-img-top" src="../img/prog.png" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Cadastrar Programador</h5>
      <button type="button" class="btn light-green accent-3 btn-rounded" style="color: white">Ir</button></a>
    </div>
  </div>
  <a href="./tabela_clientes.php" target="_blank">
  <div class="card">
    <img class="card-img-top" src="../img/tabela.png" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Tabela Clientes</h5>
      <button type="button" class="btn light-green accent-3 btn-rounded" style="color: white">Ir</button></a>
    </div>
  </div>
  <a href="./tabela_programadores.php" target="_blank">
  <div class="card">
    <img class="card-img-top" src="../img/programadores.png" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Tabela Programadores</h5>
      <button type="button" class="btn light-green accent-3 btn-rounded" style="color: white">Ir</button></a>
    </div>
  </div>
    <a href="../home.php" target="_blank">
    <div class="card">
    <img class="card-img-top" src="../img/clientes.png" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Home Clientes</h5>
      <button type="button" class="btn light-green accent-3 btn-rounded" style="color: white">Ir</button>
    </div>
  </div>
